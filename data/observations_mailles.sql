create view ref_geo.mon_territoire as select st_transform(la.geom, 3857) as geom from ref_geo.l_areas la where la.area_name = 'ALCOTRA-France';

DROP MATERIALIZED VIEW atlas.t_mailles_territoire;

CREATE MATERIALIZED VIEW atlas.t_mailles_territoire
AS 
SELECT c.geom AS the_geom,
